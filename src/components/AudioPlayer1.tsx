...
import audioBackground from "../assets/img/song-img.png";
...
const songs = [
  {
    ...
    "album-artwork": "https://521dimensions.com/img/open-source/amplitudejs/album-art/die-digital.jpg",
  },
  {
    "index": 2,
    "title": "Offcut #6",
...

  {
    ...
    "album-artwork": "https://521dimensions.com/img/open-source/amplitudejs/album-art/we-are-but-hunks-of-wood.jpg",
  },
  ...
  },
  {
    ...
    "album-artwork": "https://521dimensions.com/img/open-source/amplitudejs/album-art/from-dusk-to-dawn.jpg",
  },
];
...
export const AudioPlayer1 = () => {
  ...
  const [audio, setAudio] = useState(new Audio(currentTrack.url));
  ...
  useEffect(() => {
    //setAudio(new Audio(currentTrack.url));
  ...
  useEffect(() => {
    audio.pause();
    setErrorWhilePlaying(false);
    console.log("START FROM BEGINNING : ", currentTrackIndex, "index  ", currentTrack.url);
        ...
        <div className=" w-full h-full flex flex-col items-center justify-center">
          <div className=" h-[30%] bg-slate-300 dark:bg-gradient-to-r from-[#0A1122] to-[#0A1122] relative md:w-[60%] flex flex-col rounded-xl">
            <div className="  px-10 pt-10 pb-4 flex items-center z-50">
              <img src={currentTrack["album-artwork"]} alt="Album Cover" className=" select-none w-24 h-24 rounded-md mr-6 border border-grey-900" />

              <div className="flex flex-col">
                <span className="font-sans text-lg font-medium leading-7 text-slate-900 dark:text-white">{currentTrack.title}</span>
                <span className="font-sans text-base font-medium   text-gray-500 dark:text-gray-400">{currentTrack.year}</span>
                <span className="font-sans text-lg font-medium leading-6 text-slate-900 dark:text-white">{currentTrack.artist}</span>
                <span className="font-sans text-base font-medium leading-6 text-gray-500 dark:text-gray-400">{currentTrack.album}</span>
              </div>
            </div>
            <div className="z-100 mt-[10%] ml-[10%] h-[100%] w-[80%] opacity-25 absolute bg-sky-500 blur-2xl rounded-full "> </div>

            <div className="select-none w-full flex flex-col px-10 pb-6 z-50">
              <input
                type="range"
                min="0"
                max="100"
            ...
            <div className=" select-none h-16 z-50 bg-slate-300 dark:bg-[#171f3280]  px-6  rounded-b-xl   border-t border-gray-400 dark:border-gray-900  flex items-center justify-between z-10 ">
          ...
          <div className="z-100  mt-[20%] h-[50%] w-[80%] opacity-25 absolute bg-sky-500 blur-2xl rounded-full "> </div>
                ...
                return (
                  <SwiperSlide
                    ...
                    <div
                     ...
                     bg-gradient-to-r from-slate-300 via-[#A1CAE3] via-60% to-slate-300 dark:bg-gradient-to-r dark:from-[#0A1122] dark:via-[#0B3D5E] dark:to-[#0A1122] 
                    p-2 gap-2   cursor-pointer transition-shadow duration-300 shadow-Xl hover:shadow-inner hover:shadow-sky-300 bg-[#27293d] rounded-2xl  text-white border-1 border-sky-700`}>
                      <div className=" w-[40%] justify-center">
                        <img src={audioBackground} alt="Album Cover" className=" select-none md:h-24 rounded-md mr-2 border border-grey-900" />
                      </div>
