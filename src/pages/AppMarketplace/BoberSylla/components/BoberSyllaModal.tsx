...
export const BoberSyllaModal: React.FC<BoberModalProps> = (props) => {
  ...
  return (
    <>
      {!owned ? (
        ...
        <>
          <iframe src={data} height={innerHeightIframe(window.innerHeight)} className="w-full rounded-b-xl overflow-y-hidden" />
        </>
      )}
    </>
  );
