...
export const NFTunes = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      <div className="flex flex-col justify-center items-center gap-16 xl:gap-32 font-[Clash-Regular] w-full max-w-[100rem] bg-background ">
        ...
        <div className="flex flex-col items-start h-screen w-[90%]">
          ...
          <div className="flex flex-col xl:flex-row  w-full justify-between items-center h-full">
            ...
            <div className="relative h-full w-full xl:-mt-[15%]">
              ...
              <img
                className="absolute   left-[60%] lg:left-[50%] xl:left-[70%] top-[-30px] xl:top-[-50px] w-[30%] max-w-[200px]      "
                src={stick}
                alt="stick"
              />
            </div>
        ...
        <div className="flex flex-col justify-start items-center w-full gap-12  ">
          <div className="flex flex-col justify-center w-[80%] items-center xl:items-start">
        ...
        <div
          id="featured-artist"
          className=" bg-manu-image bg-cover	bg-top flex flex-col xl:flex-row  justify-center items-center xl:items-start  w-full h-full xl:h-full gap-12  ">
                ...
                {IS_DEVNET && (
                  <div className="flex flex-row w-full justify-center">
                    <button
                      ...
                      className="flex flex-row gap-2 text-primary justify-center items-center  p-4 rounded-lg  bg-gradient-to-br from-[#737373] from-5% via-[#A76262] via-40% to-[#5D3899] to-100%  ">
                      See all
                      <MoveDown />
                    </button>{" "}
                  </div>
            ...
            <div className="flex flex-col xl:flex-row pt-12">
              <div className="flex flex-col gap-8">
                ...
                <Link
                  ...
                  target="_blank"
                  className=" text-sm md:text-xl p-2 md:p-4 bg-gradient-to-br from-[#737373] from-5% via-[#A76262] via-30%  to-[#5D3899] to-95% rounded-lg  max-w-[50%] xl:max-w-[35%] text-primary ">
                  Try zStorage today
                </Link>
              </div>
        ...
        <div className="flex flex-col gap-4 justify-center items-center bg-primary xl:p-32 w-full h-screen text-center">
        ...
        <div className="flex flex-col justify-center items-center w-full gap-12 mt-12">
          <div className=" py-8 flex flex-col w-[90%] justify-center items-start gap-12">
            <div className="flex flex-row rounded-lg mb-4 px-8 xl:px-16 text-center gap-4 bg-foreground md:text-2xl xl:text-3xl  justify-center items-center ">
              <Music className="text-secondary" />
            ...
            <div className="flex flex-col xl:flex-row gap-8 justify-center items-center w-full">
              <Link
                ...
                target="_blank"
                className="flex flex-row items-center shadow-inner shadow-gray-600 justify-center bg-gradient-to-t  from-black from-20% to-background  to-70% brightness-125 rounded-full w-52 h-52  ">
                <img src={itheumLogo} alt="itheum logo" />
                <span className="w-[40%] text-center">Itheum Data DEX</span>
              </Link>
              <div className="flex flex-col gap-2 items-center shadow-inner shadow-gray-600 justify-center bg-gradient-to-t  from-black from-20% to-background  to-70% brightness-125 rounded-full w-52 h-52  ">
              ...
              <Link
                ...
                target="_blank"
                className="flex items-center shadow-inner shadow-gray-600 justify-center bg-gradient-to-t  from-black from-20% to-background  to-70% brightness-125 rounded-full w-52 h-52  ">
              ...
              <Link
                ...
                target="_blank"
                className="flex flex-col items-center shadow-inner shadow-gray-600 justify-center bg-gradient-to-t  from-black from-20% to-background  to-70% brightness-125 rounded-full w-52 h-52  ">
              ...
              <Link
                ...
                target="_blank"
                className="flex flex-col gap-2 items-center shadow-inner shadow-gray-600 justify-center bg-gradient-to-t  from-black from-20% to-background  to-70% brightness-125 rounded-full w-52 h-52  ">
